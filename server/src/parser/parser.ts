...
//     private assertTokenType(tokenType: TokenType, targetType: TokenType, skipUntil: readonly TokenType[]) {
//         if (tokenType !== tokenType) {
//             const msg = `'${tokenType}' expected.`;
//             this.errorStack.push(IDiagnostic.create(tokenType.range, msg));
...
//         if (!expr.completed) {
//             this.skipUntil(SKIP_TOKEN_GROUP.STAT_END);
//             this.skipIf([TokenType.SEP_SEMI]);
//             return stat;
//         }
//         stat.children.push(expr);
//         const semiExpected = this.next();
//         if (!this.assertTokenType(semiExpected, TokenType.SEP_SEMI, SKIP_TOKEN_GROUP.STAT_END)) {
//             this.skipUntil(SKIP_TOKEN_GROUP.STAT_END);
//             this.skipIf([TokenType.SEP_SEMI]);
//             return stat;
//         }
...
//         this.next();
//         const lparenExpected = this.next();
//         if (!this.assertTokenType(lparenExpected, TokenType.SEP_LPAREN, SKIP_TOKEN_GROUP.PAREN_EXP_EXPECTED)) {
//             return stat;
//         }
//         const expr = this.parseExpression();
//         if (!expr.completed) {
//             this.skipUntil(SKIP_TOKEN_GROUP.RPAREN_EXPECTED);
//             this.skipIf([TokenType.SEP_RPAREN]);
//             return stat;
//         }
//         stat.pred = expr;
//         const rparenExpected = this.next();
//         if (!this.assertTokenType(rparenExpected, TokenType.SEP_RPAREN, SKIP_TOKEN_GROUP.RPAREN_EXPECTED)) {
//             this.skipIf([TokenType.SEP_RPAREN]);
//             return stat;
//         }
...
//         stat.stat = doBody;
//         const whileExpected = this.next();
//         if (!this.assertTokenType(whileExpected, TokenType.KW_WHILE, SKIP_TOKEN_GROUP.PAREN_EXP_EXPECTED)) {
//             // 为了完整性，我们这里忽略不正确的 while 部分。
//             return doBody;
//         }
//         const lparamExpected = this.next();
//         if (!this.assertTokenType(lparamExpected, TokenType.SEP_LPAREN, SKIP_TOKEN_GROUP.PAREN_EXP_EXPECTED)) {
//             return doBody;
//         }
//         const expr = this.parseExpression();
//         if (!expr.completed) {
...
//         }
//         stat.pred = expr;
//         const rparamExpected = this.next();
//         if (!this.assertTokenType(rparamExpected, TokenType.SEP_RPAREN, SKIP_TOKEN_GROUP.PAREN_EXP_EXPECTED)) {
//             this.skipUntil(SKIP_TOKEN_GROUP.RPAREN_EXPECTED);
//             this.skipIf([TokenType.SEP_RPAREN]);
//             return doBody;
//         }
...
//         if (!init.completed) {
//             this.skipUntil(SKIP_TOKEN_GROUP.FOR_EXPR);
//             completeFlag = false;
//             if (this.lookAhead() !== TokenType.SEP_SEMI) {
//                 this.skipIf([TokenType.SEP_RPAREN]);
//                 return stat;
...
//         this.next();
//         const lparenExpected0 = this.next();
//         if (!this.assertTokenType(lparenExpected0, TokenType.SEP_LPAREN, SKIP_TOKEN_GROUP.PAREN_EXP_EXPECTED)) {
//             return stat;
//         }
...
//         }
//         stat.pred = expr0;
//         const rparenExpected0 = this.next();
//         if (!this.assertTokenType(rparenExpected0, TokenType.SEP_RPAREN, SKIP_TOKEN_GROUP.RPAREN_EXPECTED)) {
//             this.skipIf([TokenType.SEP_RPAREN]);
//             return stat;
//         }
...
//         // 总会产生一个错误
//         this.assertTokenType(this.next(), TokenType.SEP_RCURLY, []);
